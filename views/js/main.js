...
var resizePizzas = function(size) {
  ...
  // Local variable to move RandomPizzaContainer out of the loop
  // Newwidth and DX ot of the loop
  // Saved array length
...
//Generated local variables to save document.bodyscrollTop / 1250 out of the loop
...
// Calculate dynamically the pizza's number using the height property of the viewport
